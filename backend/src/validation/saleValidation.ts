...
import { SaleRequest, UpdateSaleRequest } from '../utils/interface';
...
export const updateSaleSchema: ObjectSchema<UpdateSaleRequest> = Joi.object({
  date,
  customerId,
  invoiceNumber,
  paymentType: Joi.string().valid('CASH', 'CREDIT', 'MIXED').required(),
