...
class CustomerController implements IController {
    async getAllCustomer(_req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    async updateCustomerById(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const { id } = req.params;
    ...
    async deleteCustomerById(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const { id } = req.params;
