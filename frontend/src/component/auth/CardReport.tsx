    ...
    <div className=" px-1 pt-1 pb-2 mb-5 lg:mb-8 mr-0 xs:mr-4">
      {id % 2 === 1 && (
        <>
          ...
          <div className="tex-md lg:text-lg font-normal text-justify">
            {desc}
          </div>
          <button className="mt-3 rounded-md border-2 py-1 border-black px-3 font-normal hover:bg-white hover:border-white">
            Lihat Laporan
          </button>
        </>
      )}
