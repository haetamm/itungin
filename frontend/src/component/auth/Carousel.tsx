...
export default function Carousel() {
  ...
  return (
    <div className={`${carouselStyles.carousel}  mx-auto rounded-2xl p-0 lg:px-8`}>
      <div className={` ${carouselStyles.carouselInner}`}>
          ...
          {images.map((image, index) => (
              <React.Fragment key={index}>
                  ...
                  />
                  <div className={` mx-auto justify-center mt-5 items-center ${carouselStyles.carouselItem}`}>
                    <div
                      key={index}
